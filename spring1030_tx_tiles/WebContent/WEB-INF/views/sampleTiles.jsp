...
<body>
			...
			<li class="mb-2">
				...
				<div class="collapse" id="dashboard-collapse">
					<ul class="btn-toggle-nav list-unstyled mt-2">
						...
						<li><a href="#" class "link-primary d-inline-flex text-decoration-nonerounded">NumPy</a></li>
	...
	<footer class="mt-5 p-4 text-white text-center mybgColor"> Page Footer </footer>
	<script>
		$(function() {
			$('#wbtn').click(function() {
				location = "boardForm";
